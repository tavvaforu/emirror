...
$db=new myclass;
$db->myconnect();
$tpl_object = new Template("templates/open_memories");
...
if(isset($_GET['action']) && $_GET['action']=="Remove")
{
   ...
   $tp=str_replace("{msg}",$msg,$tp);
   header("location:index.php?file=me-open_memories&id=$iid&stype=$stypes&msg=$msg#page=page-2");
}
...
$res.='<a href="#" onclick="return removememoryfile('.$attachid.','.$id.')";>Remove</a><br>' ;
$i++;
}
