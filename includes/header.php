...
alert('Post was not published.');
  ...
  <div id="header">
    ...
    <div class="welcome"><h2>Welcome <?=$_SESSION["sess_firstname"]?></h2>&nbsp;| <a href="index.php?file=u-feedback">Feedback</a>&nbsp;| <a href="index.php?file=fr-refer">Refer Friend</a>&nbsp;| <a href="index.php?file=u-logout">Logout</a></div>
