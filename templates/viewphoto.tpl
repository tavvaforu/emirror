...
<link href="{SCRIPT_URL}jalerts/jquery.alerts.css" rel="stylesheet" type="text/css" media="screen" />
	<link rel="stylesheet" href="{STYLE_URL}lightbox.css" type="text/css" media="screen" />
	
	<script src="{SCRIPT_URL}prototype.js" type="text/javascript"></script>
	<script src="{SCRIPT_URL}scriptaculous.js?load=effects,builder" type="text/javascript"></script>
	<script src="{SCRIPT_URL}lightbox.js" type="text/javascript"></script>
 ...
 <div id="profiles">
  ...
  <div class="clear"></div>
   ...
   <div class="innerdiv">
    ...
    <div class="dailytriggertabs">{PHOTOS}
    <form name="album" method="POST" action="album.php">
       <input type="hidden" name="albumid" id="albumid" value="{ALBUMID}" />	
    </form>
    <div class="clear"></div>
    </div>
	<input id="Addmore" name="Addmore" class="inr_btn" type="button" value="Add Photos" onclick="window.location.href='addalbumphotos.php?albumid={ALBUMID}';" />
