...
<script type="text/javascript" src="{SCRIPT_URL}jquery.MultiFile.js"></script>
<script type="text/javascript" src="{SCRIPT_URL}jquery.js"></script>
  <div id="inner_screen">
   <div class="login_box">
...
<div>
 ...
 <div id="profiles">
  ...
  <div class="clear"></div>
   ...
   <form action="index.php?file=p-addalbumphotos" name="albumphotoform" method="POST" enctype="multipart/form-data">
   ...
   <input type="hidden" name="photoid" id="photoid" value="{photoid}">
	...
	<h3>Add Photos to the album-{ALBUM_TITLE}</h3> <br /><br />
      <span>Title&nbsp;&nbsp;</span>
	  <input name="photo_title" id="photo_title" type="text" value="{phototitle}" style="width:200px;  margin-left:10px;" />
      <br /><br />
	   <div style="float:left; width:35px; margin-top:3px;">Photo </div><div style="float:left; width:450px; margin:0 0 10px 0;">{Photo_upload}</div>
       {IMGVIEW}
      <br /><br />	  
        {BTN}
