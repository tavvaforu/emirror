...
<div>
 ...
 <div class="favor">
	      ...
	      <ul>
            ...
            <li><img src="{IMG_URL}events_icon.gif" width="16" height="16"  class="actv"/><a href="index.php?file=me-memories"><span  class="actv">Memories</span></a></li>
...
<form enctype="multipart/form-data" id="messageform" name="messageform" method="POST" action="index.php?file=me-memories" >
...
<br /> 
 ...
 <li class="buttons ">
 <div>{DRAFT_BTN}
<input id="saveForm" onclick="javascript:window.location='index.php?file=me-memories';" name="saveForm" class="inr_btn" type="button" value="Cancel"/>
 </div>
</li>
</ul>
</form>
...
<div class="dailytriggertabs">
    ...
    <div style="margin:0 auto; padding:10px 0px; height:30px;">
   ...
   <input  id="saveForm" name="saveForm" class="inr_btn" type="button" value="Go" onclick="return valid_search('index.php?file=me-memories&stype={stype}');"/>
...
<form method="POST" action="index.php?file=me-memories">
...
<label class="choice" for="Field0_0" style="padding-left:10px; padding-right:5px; margin:0px;" ><input name="Check_All" type="checkbox"   id="Check_All" onClick="CheckAll(document.getElementsByName('check_list[]'))"  style="margin-right:5px;"/><strong>Memory</strong>
...
<div class="messagesdivv">
              ...
              <div class="nuumbers"><img src="{IMG_URL}events_icon.gif" width="16" height="11" />Number of Memories Recorded: {TOT_SENT}</div>

              <div class="nuumbers"><img src="{IMG_URL}events_icon.gif" width="16" height="15" />Number of Memories Shared: {TOT_RECEIVED}</div><div class="clearall"></div>
