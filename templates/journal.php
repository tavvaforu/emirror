<?php
define(SITE_ROOT,$_SERVER['DOCUMENT_ROOT']."/sunitha/emirror/");
...
//echo '<PRE>';print_r($_POST);exit;
	...
	if($insid)
	  header("location:journal.php?msg=$msg&stype=$saveType#page=page-2");
	?>
	...
	if($_POST['saveForm']=="Delete")
{
  ...
  header("location:journal.php?stype=$stype&msg=$msg#page=page-2");
}
...
$res.='	<span style="float:left;margin:0px 0px 5px 0px; padding:0px; width:150px;">
 ...
 $res.='<img src="{IMG_URL}attachemtn.gif" width="16" height="14" alt="attachemet" />';
  ...
  if($send_type==0) { 
  $res.='<a href="journal.php?id='.$id.'">'.$message.'</a>';
   } else{
  $res.='<a href="open_journal.php?stype='.$send_type.'&id='.$id.'">'.$message.'</a>';
  }
$res.='</label>
</span>
  ...
  <a href="#"><img src="{IMG_URL}twitter_icon.gif" width="16" height="16" /></a><a href="#" onclick="return checkjournalDelete('.$id.')";><img src="{IMG_URL}delete.gif" width="13" flot="right"height="13" /></a></div>
</div>';
...
{
$tp=str_replace("{MSG_SORT}",'<a href="journal.php?stype='.$send_type.'&keyword='.$keyword.'&fromdate='.$fromdate.'&todate='.$todate.'&order=message&otype=d#page=page-2" >
<img src="{IMG_URL}up_arrow.png" width="12" height="6" alt="descendingorder" title="Descending Sort" align="absmiddle"  border="0" /></a>',$tp);
}
else
{
$tp=str_replace("{MSG_SORT}",'<a href="journal.php?stype='.$send_type.'&keyword='.$keyword.'&fromdate='.$fromdate.'&todate='.$todate.'&order=message&otype=a#page=page-2" >
...
{
$tp=str_replace("{SENDER_SORT}",'<a href="journal.php?stype='.$send_type.'&keyword='.$keyword.'&fromdate='.$fromdate.'&todate='.$todate.'&order='.$osender.'&otype=d#page=page-2" >
<img src="{IMG_URL}up_arrow.png" width="12" height="6" alt="descendingorder" title="Descending Sort" align="absmiddle"  border="0" /></a>',$tp);
}
else
{
$tp=str_replace("{SENDER_SORT}",'<a href="journal.php?stype='.$send_type.'&keyword='.$keyword.'&fromdate='.$fromdate.'&todate='.$todate.'&order='.$osender.'&otype=a#page=page-2" >
<img src="{IMG_URL}down_arrow.png" width="12" height="6" alt="ascendingorder" title="Ascending Sort" align="absmiddle"  border="0" /></a>',$tp);
}
if($order=="create_time" && $otype=="a")
{
$tp=str_replace("{TIME_SORT}",'<a href="journal.php?stype='.$send_type.'&keyword='.$keyword.'&fromdate='.$fromdate.'&todate='.$todate.'&order=create_time&otype=d#page=page-2" >
<img src="{IMG_URL}up_arrow.png" width="12" height="6" alt="descendingorder" title="Descending Sort" align="absmiddle"  border="0" /></a>',$tp);
}
else
{
$tp=str_replace("{TIME_SORT}",'<a href="journal.php?stype='.$send_type.'&keyword='.$keyword.'&fromdate='.$fromdate.'&todate='.$todate.'&order=create_time&otype=a#page=page-2" >
<img src="{IMG_URL}down_arrow.png" width="12" height="6" alt="ascendingorder" title="Ascending Sort" align="absmiddle"  border="0" /></a>',$tp);
}
if($order=="message_intensity" && $otype=="a")
{
$tp=str_replace("{INTENSITY_SORT}",'<a href="journal.php?stype='.$send_type.'&keyword='.$keyword.'&fromdate='.$fromdate.'&todate='.$todate.'&order=message_intensity&otype=d#page=page-2" >
<img src="{IMG_URL}up_arrow.png" width="12" height="6" alt="descendingorder" title="Descending Sort" align="absmiddle"  border="0" /></a>',$tp);
}
else
{
$tp=str_replace("{INTENSITY_SORT}",'<a href="journal.php?stype='.$send_type.'&keyword='.$keyword.'&fromdate='.$fromdate.'&todate='.$todate.'&order=message_intensity&otype=a#page=page-2" >
<img src="{IMG_URL}down_arrow.png" width="12" height="6" alt="ascendingorder" title="Ascending Sort" align="absmiddle"  border="0" /></a>',$tp);
}
...
<input id="saveForm" onclick="return valid_journalform(document.messageform);" name="saveForm" class="inr_btn" type="submit" value="Save"/>
   ',$tp);
