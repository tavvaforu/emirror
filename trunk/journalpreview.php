...
<div style=" width:100px; font-size:12px; font-weight:bold; float:right;"><?=$date?></div>
 ...
 <label class="desc" id="title1" for="Field1" style="margin-top:5px; width:300px; float:left;" ><span id="title1"></span> </label>
...
var title=window.opener.document.getElementById('title_journal').value;
//alert(title);
...
document.getElementById('message_pr').innerHTML ='<pre style=" font-family:Arial, Helvetica, sans-serif; font-size:12px; color:#333; margin-top:15px;">'+message+'</pre>';
