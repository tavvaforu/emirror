...
$tpl_object = new Template("templates/feedback");
...
$tp=str_replace("{BTN}",'<input id="saveForm" onclick="return valid_feedbackform(document.feedbackform);" name="saveForm" class="inr_btn" type="submit" value="Send"/>',$tp);
