...
$db=new myclass;
$db->myconnect();
$tpl_object = new Template("templates/open_journal");
...
//echo "delete from messagetrigger where id=".$iId;exit;
 ...
 $msg="Record deleted succesfully";
  ...
  //echo "journal.php?stype=$stype&msg=$msg#page=page-2";
...
if(isset($_GET['action']) && $_GET['action']=="Remove")
{
   ...
   $tp=str_replace("{msg}",$msg,$tp);
   header("location:index.php?file=j-open_journal&id=$iid&stype=$stypes&msg=$msg#page=page-2");
}
...
$res.='<a href="#" onclick="return removejournalfile('.$attachid.','.$id.')";>Remove</a><br>' ;
$i++;
