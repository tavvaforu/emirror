...
<!--firstdiv Starts-->
	    ...
	    <div class="firstdiv">    
	      ...
	      <ul>
            ...
            <li><a href="index.php?file=t-trigger" class="actv"><img src="{IMG_URL}news_feed.gif" width="16" height="16"/><span  class="actv">Daily Trigger</span></a></li>
  ...
  <div class="innerdiv">
   ...
   <div class="clear"></div>
    ...
    <div class="dailytriggertabs">
     ...
     <form enctype="multipart/form-data" id="messageform" name="messageform" method="POST" action="index.php?file=t-trigger" >
...
text-decoration: underline;" href="javascript:addFileInput();">Attach another File</a></div>
   ...
   <li id="foli1" class="complex" style="margin-top:15px;">
    ...
    <span style="float:left; width:50px;">
     ...
     <input id="faceid" name="faceid" type="radio" class="field radio" value="f" tabindex="1"  />
    ...
    <span style="float:left; width:50px;">
     ...
     <input id="faceid" name="faceid" type="radio" class="field radio" value="t" tabindex="1"   />
    ...
    <span style="float:left; width:50px;">
     ...
     <input id="faceid" name="faceid" type="radio" class="field radio" value="n" checked="checked" tabindex="1"   />
   ...
   <li class="buttons ">
  <div>{DRAFT_BTN}
  <input id="saveForm" onclick="javascript:window.location='index.php?file=t-trigger';" name="saveForm" class="inr_btn" type="button" value="Cancel"/>
  </div>
</li>
   ...
   <input  id="saveForm" name="saveForm" class="inr_btn" type="button" value="Go" onclick="return valid_search('index.php?file=t-trigger&stype={stype}');"/>
...
<form method="POST" action="index.php?file=t-trigger">
...
<label class="choice" for="Field0_0" style="padding-left:10px; padding-right:5px; margin:0px;" ><input name="Check_All" type="checkbox"   id="Check_All" onClick="CheckAll(document.getElementsByName('check_list[]'))"  style="margin-right:5px;"/><strong>Trigger</strong>
...
<div class="clearall"></div>
    ...
    <div class="dailytriggertabs">
	 ...
	 <form id="form" name="form66" >
              ...
              <div class="nuumbers"><img src="{IMG_URL}news_feed.gif" width="16" height="15" />No.of Triggers Shared: {TOT_RECEIVED}</div><div class="clearall"></div>
