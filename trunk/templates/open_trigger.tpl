...
<div class="favor">
	      ...
	      <ul>
            ...
            <li><a href="index.php?file=t-trigger" class="actv"><img src="{IMG_URL}news_feed.gif" width="16" height="16" />Daily Trigger</a></li>
 ...
 <div id="profiles">
   ...
   <span class="imgcapicons"> <li><a href="#"  rel="tooltip" title="Export"><img src="{IMG_URL}export.png" width="20" height="20" alt="Export" /></a></li>  
    ...
    </span> <span class="imgcapicons"> <li><a href="#"  rel="tooltip" title="print" onclick="return mypopupMessagePrint({iId},{stype});"/><img src="{IMG_URL}Print _icon.png" width="20" height="20"></a></li>  
    </span></ul>
   ...
   <div class="innerdiv">
    ...
    <div class="dailytriggertabs">
     ...
     <form id="form66" name="form66" method="POST" action="index.php?file=t-open_trigger">
...
<div style="margin:0 0 10px 0; padding:0; width:400px">
  <input onclick="window.location.href='index.php?file=t-trigger#page=page-2';" id="saveForm" name="saveForm" class="inr_btn" type="button" value="Back to View" /> 
  <input onclick="window.location.href='index.php?file=t-trigger&id={iId}';" id="saveForm" name="saveForm" class="inr_btn" type="button" value="Edit" /> 
  <input  id="saveForm" name="saveForm" class="inr_btn" type="submit" value="Delete" /> 
  <!--<input  id="saveForm" name="saveForm" class="inr_btn" type="submit" value="Block"/> 
  <input  id="saveForm" name="saveForm" class="inr_btn" type="submit" value="Unblock"/> -->
</div>
...
<div class="clear"></div>
 ...
 <label class="desc" id="title1" for="Field1" style="margin-top:5px; width:300px; float:left;" >{TITLE} </span></label>
  ...
  Emotion Type<span style=" padding-left:20px">{EMOTION}</span></label>


<div class="clear"></div>

 <p style=" font-family:Arial, Helvetica, sans-serif; font-size:12px; color:#333; margin-top:15px;">
 {MESSAGE}
 </p>
