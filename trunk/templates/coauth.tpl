  ...
  <div class="clear"></div>
   ...
   <div class="innerdiv">
    ...
    <div style="width:700px; padding:10px 0;">
      ...
      <span style="font-size:12px; font-weight:bold; color:#0075b7;">Refer A Friend </span>
	 <br/><br/>
	<div align="center" >
	<a  style="font-size:25px;font-weight:bold;" href="https://accounts.google.com/o/oauth2/auth?client_id=1025488513849.apps.googleusercontent.com&redirect_uri=http://localhost/oauth/oauth.php&scope=https://www.google.com/m8/feeds/&response_type=code">Click here to Import Gmail Contacts</a>
	</div>
      </div>   
