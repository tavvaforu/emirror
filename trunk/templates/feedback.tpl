  ...
  <div class="clear"></div>
   ...
   <div class="innerdiv">
    ...
    <div style="width:700px; padding:10px 0;">
      ...
      <span style="font-size:12px; font-weight:bold; color:#0075b7;">Feedback </span>
      </div>   
      <form name="profileform" method="POST" class="form label-inline" action="index.php?file=u-feedback"  enctype="multipart/form-data">
