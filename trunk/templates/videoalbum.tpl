...
<div class="favor">
 ...
 <div id="profiles">
  ...
  <div class="clear"></div>
   ...
   <form action="index.php?file=v-videoalbum" name="videoalbumform" method="POST" enctype="multipart/form-data">
   <input type="hidden" name="vid" value="{ALBUM_ID}">
	...
	<h3>{MODE1} Album</h3><br>
	  ...
	  <input name="video_title" id="video_title" type="text" value="{ALBUM_TITLE}" style="width:200px;  margin-left:10px;" />
      <br /><br />
	   <span>Album Photo</span>
	  <input name="video_photo" id="video_photo" type="file" style="width:200px;margin-left:10px;" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{IMGVIEW}
      <br /><br />
