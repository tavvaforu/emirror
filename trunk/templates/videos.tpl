...
<div class="favor">
     ...
     <div class="favor">
	  ...
	  <ul>
        ...
        <li><a href="index.php?file=v-videos" class="actv" ><img src="{IMG_URL}video.gif" width="16" height="16"/><span  class="actv">Videos</span></a></li>
 ...
 <div id="profiles">
  ...
  <div class="clear"></div>
   ...
   <div class="innerdiv">
    ...
    <form name="vidoefrm" method="POST" action="index.php?file=v-videoalbum">
    <input id="saveForm" name="saveForm" class="inr_btn" type="submit" value="Create Video Album" />
	{PHOTOS}
    </form>
    <div class="clear"></div>
    </div>
